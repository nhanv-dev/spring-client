                ...
                <div className="py-6 flex-1">
                    <div className="border-b border-border mb-5">
                        ...
                        <div className="p-5 pt-3 rounded-md bg-[#FAFAFA] mb-5">
                            ...
                            {product.discount &&
                                <div className="">
                                    <p className="mb-1 text-black-2 text-base font-semibold opacity-80">
                                        <span className="mr-3">Giá gốc:</span>
                                        <span className="line-through">{formatCurrency(product.discount.price)}</span>
                                    </p>
                                    <div className="flex items-center justify-start gap-5">
                                        <p className="text-3xl font-semibold text-red">
                                            {formatCurrency(product.discount.finalPrice)}
                                        </p>
                                        <div
                                            className="mt-1 relative font-bold bg-red text-white px-3 rounded-md text-md">
                    ...
                    {product?.attributes?.map(attribute => {
                        return (<div key={attribute.id} className="flex items-center flex-row mb-5">
                            ...
                            <div className="flex-1 flex items-center gap-2.5 flex-wrap">
                                {attribute?.options?.map(option => {
                                    ...
                                    return (<button key={option.id}
                                        ...
                                        {option.image && <p className="flex items-center justify-center">
