            ...
            {!product?.description ?
                <div>
                    ...
                    <div className="relative">
                        <div
                            className={`${isShow ? 'bottom-0' : 'bottom-0 top-[-10rem]'} bg-gradient-to-b from-[#e7e8ea] to-[#fff] absolute border-none w-[100%]`}>
                            <button onClick={() => setIsShow(prev => !prev)}
                                    className={`${isShow ? '' : 'absolute bottom-0'} rounded-md font-bold px-4 h-[40px] w-[100%] bg-[#e7e8ea] text-[#3f4b53] hover:bg-[#F3F3F3] active:bg-[#e7e8ea]`}>
